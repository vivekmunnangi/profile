...
@media (max-width: 768px) {{
  .sidebar {{ position: fixed; top: 80px; width: 100%; height: auto; box-shadow: 0 2px 5px rgba(0,0,0,0.1); z-index: 1000; padding: 1rem; }}
  .content {{ margin-left: 0; padding: 1rem; margin-top: 220px;}}
}}
</style>
</head>
<body>
